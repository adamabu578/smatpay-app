...
class TWalletBalanceBlackScreen extends StatefulWidget {
  @override
  _TWalletBalanceBlackScreenState createState() =>
      _TWalletBalanceBlackScreenState();
}

// State class for TWalletBalanceBlackScreen
class _TWalletBalanceBlackScreenState extends State<TWalletBalanceBlackScreen> {
  String? userId;
  String? customerId;
