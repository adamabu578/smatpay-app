...
class TPhoneNoScreen extends StatefulWidget {
  const TPhoneNoScreen({super.key});

  @override
  State<TPhoneNoScreen> createState() => _TPhoneNoScreenState();
}

class _TPhoneNoScreenState extends State<TPhoneNoScreen> {
